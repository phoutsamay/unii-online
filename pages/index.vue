<template>
  <div>
      ...
      <div class="container pt-4">
        <div class="row">
          <div class="col-md-6">
            ...
            <b-button href="#" target="blank" class="btn btn-purple mb-3"
              >สมัครอบรม</b-button
            >
          </div>
    ...
    <section id="service">
      <div class="container">
        <!-- <h1>
          หลากหลายการบริการจาก ยูนี่ ออนไลน์ ที่พร้อมมอบบริการที่ดีที่สุดกับคุณ
        </h1> -->
        <div>
          <b-card-group deck>
            <b-card
    ...
    <section id="news">
      <div class="container mt-5">
        <div class="row py-5">
          <h3>ข้าวสารจาก ยูนี่ ออนไลน์</h3>

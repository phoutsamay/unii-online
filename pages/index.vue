  ...
  <div>
    ...
    <section id="process">
      <div class="container border mt-3 py-3">
        <h1 class="mt-3">เส้นทางวงจรธุรกิจ รีไซเคิลของ Unii</h1>
        <img src="../assets/imgs/PTCF.png" alt="" width="100%" />

        <b-card>
          <b-card-title
            ><h1>เป้าหมาย ลดต้นทุน/ลดเวลา/เพิ่มรายได้</h1></b-card-title
          >
          <b-card-text
            ><ul>
              <li>
        ...
        <b-card>
          <b-card-title><h1>ลดต้นทุน/ลดเวลา/เพิ่มรายได้</h1></b-card-title>
          <b-card-text
            ><ul>
              <li>ลดต้นทุน 20,000 บาท/เดือน (กว่า 71%)</li>
              <li>
                ลดเวลาทำงานเหลือ 2 วัน/เที่ยว (กว่า 73%) เพิ่มรายได้ 20,000
                บาท/เดือน 240,000 บาท/ปี ได้วันว่าง 22 วัน/เดือน 264 วัน/ปี
              </li>
            </ul></b-card-text
          >
        </b-card>
    ...
    <section id="blog">
      <div class="container py-5">
        <div>
          <b-card-group deck>
            <b-card
              title="การสร้างเครือข่ายธุรกิจสำคัญอย่างยิ่ง"
